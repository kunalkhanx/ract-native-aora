...
const SignIn = () => {
  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      <ScrollView>
        <View className="w-full justify-center items-center h-full min-h-[85vh] px-4 my-6">
          ...
          <CustomButton title={'Sign In'} handlePress={submit} containerStyles={'mt-7 w-full'} isLoading={submitting} />
